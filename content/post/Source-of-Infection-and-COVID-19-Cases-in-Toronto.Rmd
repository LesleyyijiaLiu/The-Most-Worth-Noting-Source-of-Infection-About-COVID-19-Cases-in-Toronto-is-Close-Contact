...
I chose *About COVID-19 Cases in Toronto* dataset from *Toronto Open Data* to find out which infection has the strongest relationship with the COVID-19 cases in Toronto. I drew a Bar Plot which include a list of source of infections related to the cases. Each category shows how many cases are related to one specific infection, which is clear to be concluded. Base on the bar plot, I found that **Close contact** has the highest count for about **6500** cases. Which means most of the observants was in close contact with a confirmed or probable COVID-19 case, for example they were reside in the same household with a confirmed or probable COVID-19 case. Code and data supporting this analysis is available at: https://github.com/LesleyyijiaLiu/The-Most-Worth-Noting-Source-of-Infection-About-COVID-19-Cases-in-Toronto-is-Close-Contact
